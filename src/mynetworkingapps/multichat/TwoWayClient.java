 ...
 * @author ABHIRAJ
 */
public class TwoWayClient extends javax.swing.JFrame {
    ...
    private void jButton3ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton3ActionPerformed
        ...
        jTextArea1.append("client : " + jTextField1.getText() + "\n");
        jTextField1.setText("");
        pw.flush();
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(TwoWayClient.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new TwoWayClient().setVisible(true);
            }
        });
    }
